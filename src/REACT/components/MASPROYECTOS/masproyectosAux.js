const MasProyectosAux = [
  {
    ...
    Lenguaje: "Bootstrap",
    TextoCard:
      "Una simulacion de una pagina para anunciar una conferencia y compra de tickets",
  ...
  },
  {
    ...
    Lenguaje: "HTML-CSS",
    TextoCard:
      "Creación de pagina Batatabit basado en diesño de FIGMA.Creado con metodologia Mobile First",
    Link: "https://ja54312.github.io/MOBILE_FIRST/",
    ButtonText: "Ir a la web",
  },
];

export default MasProyectosAux;
