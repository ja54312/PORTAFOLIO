  ...
  return (
    <>
      <section className="SobreMi">
        ...
        <h4 className="text-sobre-mi">
          También Soy Gamer. Actualmente tengo conocimiento de
          React,Typescript,NextJs,NodeJs,Express,Docker y me encuentro mejorando
          mi conocimiento del mismo. Actualmente trabajo en una agencia de
          e-comerce como Desarrollador Front-end.
        </h4>
        <br />
